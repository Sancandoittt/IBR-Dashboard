...
# Regression
st.subheader("Regression: What drives positive reaction to AI shopping assistants?")
...
# Adoption Rate with safe handling
...
# Dynamic Recommendations (safe use of adoption_rate)
